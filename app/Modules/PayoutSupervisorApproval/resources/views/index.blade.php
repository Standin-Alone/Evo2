@extends('global.base')
@section('title', "Payout Supervisor Approval")
...
<div class="row">
    <div class="col-md-6">
        <div class="input-group">
            <h1 class="page-header">Payout Supervisor Approval</h1>                                  
        </div>
    </div>
    <div class="col-md-6">
        <ol class="breadcrumb pull-right">
            <li class="breadcrumb-item"><a href="{{ route('SupplierModule.index') }}">Home Page</a></li> 
            <li class="breadcrumb-item active">Payout Supervisor Approval</li>
        </ol>   
    </div>
</div>
<div class="row">
