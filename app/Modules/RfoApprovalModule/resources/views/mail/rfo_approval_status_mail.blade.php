                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h4
                                                                ...
                                                                <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">Hi <b>{{$user_data['created_by_fullname']}}</b>!</h4>
                                                                <br />
                                                                @if ($user_data['approval_status'] == 0)
                                                                    <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                                        The Supplier branch status are
                                                                        <b style="color:rgb(56, 125, 253)">{{$user_data['approval_status_name']}}</b>
                                                                    </h4>
                                                                @elseif ($user_data['approval_status'] == 1)
                                                                    <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                                        The Supplier branch status are
                                                                        <b style="color:rgb(60, 236, 44)">{{$user_data['approval_status_name']}}</b>
                                                                    </h4>
                                                                @elseif ($user_data['approval_status'] == 2)
                                                                    <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                                        The Supplier branch status are
                                                                        <b style="color:rgb(236, 75, 75)">{{$user_data['approval_status_name']}}</b>
                                                                    </h4>
                                                                @endif
                                                                <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">Below is your latest update details.</h4>
                                                                <br />
                                                                <table id="customers">
                                                                    <tr>
                                                                      ...
                                                                      <tr>
                                                                        <th style="width: 150px;">Created Agency</th>
                                                                        <td>{{$user_data['created_agency']}}</td>
                                                                      </tr>
                                                                      <tr>
                                                                        <th style="width: 150px;">Approved By</th>
                                                                        <td>{{$user_data['approved_by_fullname']}}</td>
                                                                      </tr>
                                                                      <tr>
                                                                        <th style="width: 150px;">Activation Status</th>
                                                                        <td> 
                                                                            @if ($user_data['approval_status'] == 0)
                                                                                <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                                                    <b style="color:rgb(56, 125, 253)">{{$user_data['approval_status_name']}}</b>
