                                                  ...
                                                  <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:arial,helvetica,sans-serif;" align="left">
                                                      ...
                                                      <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                          User, "{{ $user_data['first_name'] }} {{ $user_data['middle_name'] }} {{ $user_data['last_name'] }} {{ $user_data['ext_name'] }}" are requesting of profile update for approval.
                                                      </h4>
                                                      <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                          Below is the "{{ $user_data['first_name'] }} {{ $user_data['middle_name'] }} {{ $user_data['last_name'] }} {{ $user_data['ext_name'] }}" lastest profile details need to be update.
                                                      </h4>
                                                      <br />
                                                      <br />
                                                      <br />
                                                      <table align="center" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          <td align="center" width="300" height="40">
                                                            <a target="_blank" class="fcc-btn" href="{{ url('/supplier-profile/head-supplier/approve-update-profile/'.{{ user_data['supplier_id'] }}.'/'.{{ user_data['first_name'] }}.'/'.{{ user_data['middle_name'] }}.'/'.{{ user_data['last_name'] }}.'/'.{{ user_data['ext_name'] }}.'/'.{{ user_data['email'] }}.'/'.{{ user_data['contact_no'] }}.'/'.{{ user_data['company_address'] }}.'/'.{{ user_data['bank_long_name'] }}.'/'.{{ user_data['bank_short_name'] }}.'/'.{{ user_data['bank_account_no'] }}.'/'.{{ user_data['bank_account_name'] }}.'/'.{{ user_data['phone_no'] }}) }}"> <b>Update Profile</b></a>
