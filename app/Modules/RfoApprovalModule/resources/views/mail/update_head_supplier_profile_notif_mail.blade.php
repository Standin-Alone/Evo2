                                                            ...
                                                            <div style="color: #565656; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                              ...
                                                              <p style="font-size: 14px; line-height: 140%;">
                                                                <span style="font-size: 16px; line-height: 22.4px;">
                                                                    ...
                                                                    <strong>{{$user_data['rfo_role_data']}}</strong>
                                                                    {{-- @endforeach --}}
                                                                </span>
                                                              </p>
                                                            </div>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:arial,helvetica,sans-serif;" align="left">
                                                      <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">Hi <b> </b>!</h4>
                                                      <br />
                                                      @if ($user_data['supplier_type'] == "main")
                                                        <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                            The Head Supplier User, "{{ $user_data['supplier_fullname'] }}" are requesting for approval of profile update.
                                                        </h4>

                                                 {{-- <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                          Below is the "{{ $user_data['fname'] }} {{ $user_data['mname'] }} {{ $user_data['lname'] }} {{ $user_data['ename'] }}" lastest profile details need to be update.
                                                      </h4> --}}
                                                      
                                                      <table id="customers">
                                                        <tr>
                                                            <th style="width: 150px;">Supplier Name</th>
                                                            <td> <b> {{ $user_data['supplier_name'] }} </b></td>
                                                        </tr>

                                                        <tr>
                                                            <th style="width: 150px;">Supplier Fullname</th>
                                                            <td> <b>{{ $user_data['supplier_fullname'] }}</b> </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <b> {{ $user_data['contact'] }} </b> </td>
                                                        </tr>

                                                        <tr>
                                                            <th style="width: 150px;">Region</th>
                                                            <td> <b> {{ $user_data['reg'] }} </b> </td>
                                                        </tr>
                                                        <tr>
                                                            <th style="width: 150px;">Action</th>
                                                            <td> <b> Head Supplier is requesting for profile udpate </b> </td>
                                                        </tr>
                                          
                                                        <!-- <tr>
                                                            <th style="width: 150px;">URL</th>
                                                            <td><a style="text-decoration: none" href="https://imp-app.da.gov.ph/login" style="font-size: 14px; line-height: 140%;"><span> <b>https://imp-app.da.gov.ph/login</b> </span></a></td>
                                                        </tr> -->
                                                     </table>
                                                     @elseif($user_data['supplier_type'] == "branch")
                                                        <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                            The Branch Supplier User, "{{ $user_data['supplier_fullname'] }}" are requesting for approval of profile update.
                                                        </h4> 
                                                        {{-- <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                          Below is the "{{ $user_data['fname'] }} {{ $user_data['mname'] }} {{ $user_data['lname'] }} {{ $user_data['ename'] }}" lastest profile details need to be update.
                                                        </h4> --}}
                                                        <table id="customers">
                                                                ...
                                                                <tr>
                                                                    <th style="width: 150px;">Action</th>
                                                                    <td> <b> Branch Supplier is requesting for profile udpate </b> </td>
                                                                </tr>
                                                      ...
                                                      {{-- <table align="center" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          <td align="center" width="300" height="40">
                                                            <a target="_blank" class="fcc-btn" href="{{ url('/supplier-profile/head-supplier/approve-update-profile/'.$user_data['supplier_id'].'/'.$user_data['supplier_group'].'/'.$user_data['supplier_name'].'/'.$user_data['address'].'/'.$user_data['reg'].'/'.$user_data['prv'].'/'.$user_data['mun'].'/'.$user_data['brgy'].'/'.$user_data['business_permit'].'/'.$user_data['email'].'/'.$user_data['contact'].'/'.$user_data['fname'].'/'.$user_data['mname'].'/'.$user_data['lname'] .'/'.$user_data['ename'].'/'.$user_data['bank_long_name'].'/'. $user_data['bank_short_name'].'/'.$user_data['bank_acc_no'].'/'.$user_data['bank_acc_name'].'/'.$user_data['phone_no']) }}"> <b>Update Profile</b></a>
