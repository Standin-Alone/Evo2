                                                              ...
                                                              <span style="font-size: 16px; line-height: 22.4px;">
                                                                <strong>
                                                                  <span style="color: #595959; line-height: 22.4px; font-size: 16px;">
                                                                    {{$user_data['fullname']}}
                                                                    {{-- {{ $user_data['fname'] }} {{ $user_data['mname'] }} {{ $user_data['lname'] }} {{ $user_data['ename'] }} --}}
                                                                  </span>
                                                                </strong>
                                                              </span>
                                                            </p>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td style="overflow-wrap:break-word;word-break:break-word;padding:15px;font-family:arial,helvetica,sans-serif;" align="left">
                                                      <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">Hi <b> {{ $user_data['fullname'] }} </b>!</h4>
                                                      <br />
                                                      <h4 style="display: block; margin-block-start: 1.33em; margin-block-end: 1.33em; margin-inline-start: 0px; margin-inline-end: 0px; font-weight: bold;">
                                                        Your profile have been approved and updated by the RFO Approval! To check your updated profile go to "Supplier Profile Tab".
                                                      </h4>
                                                      <br />
                                                      <br />
                                                      <br />
