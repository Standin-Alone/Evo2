@extends('global.base')
@section('title', "Vouchers Approved Payout")
...
@section('page-js')    
    ...
    <script type="text/javascript">
       $(document).ready(function() {
            ...
            // CALL DATATABLE
            getApprovedPayoutDetails();

            // DISPLAY DATATABLE
            function getApprovedPayoutDetails(){
                    $('#VoucherApprovedPayout-datatable').unbind('click');
                var table = $('#VoucherApprovedPayout-datatable').DataTable({
                    destroy: true,
                    processing: true,
                    serverSide: true,
                    responsive: true,
                    ajax: "{{ route('get.VoucherApprovedPayoutList') }}"+'?program_id='+selectedProgramId,
                    dom: 'Bfrtip',
                        buttons: [
                    ...
                    footerCallback: function (row, data, start, end, display) { 
                        var TotalAmount = 0;                                        
                            ...
                            $('.totalvoucherapprovedpayoutamt').html($.fn.dataTable.render.number(',', '.', 2, '&#8369;').display( TotalAmount ));                    
                    }
                }).ajax.reload();
...
<div class="row">
    <div class="col-md-6">
        <div class="input-group">
            <h1 class="page-header">Vouchers Approved Payout</h1>                                  
        </div>
    </div>
    <div class="col-md-6">
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">Vouchers Approved Payout</li>
        </ol>   
    </div>
</div>
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="note note-success">
            ...
            <div class="note-content">
                ...
                <h3><span class="totalvoucherapprovedpayoutamt">₱ 0.00</span></h3>
            </div>
        </div>
    </div>
</div>
<div class="panel panel-success">
    ...
    <table id="VoucherApprovedPayout-datatable" class="table table-striped display nowrap" style="width: 100%;"> 
