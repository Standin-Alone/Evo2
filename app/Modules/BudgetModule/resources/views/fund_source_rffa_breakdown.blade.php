...
@section('page-js')
    ...
    @include('BudgetModule::components.js.datatables.rffa_breakdown_datatable')
@endsection
...
<div class="panel panel-inverse mt-5">
    ...
    <div class="panel-body mt-5">
        <table id="fund_source_breakdown_tbl_rffa" class="table table-striped table-bordered table-hover text-center mt-5" style="width:100%;">            
