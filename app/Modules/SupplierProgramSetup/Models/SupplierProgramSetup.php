...
namespace App\Modules\SupplierProgramSetup\Models;
...
class SupplierProgramSetup extends Model
{
    use HasFactory;

    public function get_SupplierProgramDetails($supplier_id){
    ...
    public function insert_SupplierProgram($params){
        $insert_SupplierProgram_values = DB::transaction(function() use(&$params){
        ...
        return $insert_SupplierProgram_values;
    }

    public function update_SupplierProgram($params){
        $update_SupplierProgram_values = DB::transaction(function() use(&$params){
            DB::table('supplier')
        ...
        return $update_SupplierProgram_values;
    }

    public function remove_SupplierProgram($supplier_id){
        $remove_SupplierProgram_values = DB::transaction(function() use(&$supplier_id){
            DB::table('supplier')
                ->where('supplier_id',$supplier_id)
                ->delete();
        });
        return $remove_SupplierProgram_values;
    }
}
