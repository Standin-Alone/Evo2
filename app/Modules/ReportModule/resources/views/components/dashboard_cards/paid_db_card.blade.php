<div class="col-lg-3 col-md-6">
    <div class="widget widget-stats bg-gradient-blue">
        ...
        <div class="stats-content">
            <div class="stats-title" style="font-size: 14px">Number of Claimed Vouchers :</div>
            @foreach ($total_no_of_paid_voucher_transactions as $data)
...
<div class="col-lg-3 col-md-6">
    <div class="widget widget-stats bg-gradient-red">
        <div class="stats-icon stats-icon-lg"><i class="fa fa-dollar-sign fa-fw"></i></div>
        <div class="stats-content">
            <div class="stats-title" style="font-size: 14px">GRAND TOTAL OF CLAIMED VOUCHERS : </div>
