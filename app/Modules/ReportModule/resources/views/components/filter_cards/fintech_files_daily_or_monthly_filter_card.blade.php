    ...
    <div class="panel-body border">
        <form class="form-horizontal form-bordered">
          <div class="form-group row">
            <div id="fintech_file_daterangepicker" class="pull-left mt-2 mb-2" data-route="{{route('reports.rffa_fintech_files')}}" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; height: 100%; width: 100%">
