            ...
            var table = $('#co-program-focal-datatable-by-region-province-municipality-and-barangay').DataTable({
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    total_upload_kyc = api
                            ...
                            .reduce( function (a, b) {
                                        return (a)*1 + (b)*1;}, 0 );
                            $( api.column( 4 ).footer() ).html("Total no. of Uploaded KYC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(total_upload_kyc) );
                    ...
                    total_no_disbursed = api
                            ...
                            .reduce( function (a, b) {
                                        return (a)*1 + (b)*1;}, 0 );
                            $( api.column( 5 ).footer() ).html("Total no. of Disbursed:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(total_no_disbursed) );
                    ...
                    total_amount = api
                            ...
                            .reduce( function (a, b) {
                                        return (a)*1 + (b)*1;}, 0 );
                            $( api.column( 6 ).footer() ).html("Total amount:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',', '.', 2, '&#8369;').display(total_amount) );
                }
            });
        }
    });
