<script type="text/javascript">
    $(function() {
        ...
        if($region != 13){
                            ...
                            buttons: [
                                {
                                    ...
                                    title: 'Report: By Region Summary',
                                    extend: 'print',
                                    footer: true,
                                    exportOptions: {
                                        columns: ':visible'
            ...
            var table = $('#co-program-focal-datatable').DataTable({
                ...
                "buttons": [
                            {
                                ...
                                buttons: [
                                    {
                                        text: '<i class="fas fa-print"></i> PRINT',
                                        title: 'Report: By Region, and Province Summary',
                                        extend: 'print',
                                        footer: true,
                                        exportOptions: {
                                            columns: ':visible'
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    total_no_disbursed = api
                            ...
                            .reduce( function (a, b) {
                                        return (a)*1 + (b)*1;}, 0 );
                            $( api.column( 4 ).footer() ).html("Grand Total no. of Disbursed:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(total_no_disbursed) );
                    ...
                    total_amount = api
                            ...
                            .reduce( function (a, b) {
                                        return (a)*1 + (b)*1;}, 0 );
                            $( api.column( 5 ).footer() ).html("Grand Total Amount:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',', '.', 2, '&#8369;').display(total_amount) );
                },
            });
            ...
            */
            multi_select_region_table_02();

            /**
             * Mutli-Select Filter
             * Location: ReportModule::components.js.dropdown.by_reg_prov_muni_and_brgy_summary_dynamic_dropdown
            */
            multi_select_province_table_02();
