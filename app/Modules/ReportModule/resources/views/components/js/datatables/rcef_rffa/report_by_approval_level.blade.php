<script type="text/javascript">
    $(function() {
        ...
        if($region != 13){
            var table = $('#rfo-program-focal-report_approval').DataTable({
                destroy: true,
                processing: true,
                serverSide: false,
                responsive: true,
                                ...
                                buttons: [
                                    {
                                        ...
                                        title: 'Report: Report by approval level',
                                        extend: 'print',
                                        footer: true,
                                        exportOptions: {
                                            columns: ':visible'
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    total_upload_kyc = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 1 ).footer() ).html("Grand Total no. of Uploaded KYC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(total_upload_kyc) );
                    ...
                    generate_beneficiaries = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 2 ).footer() ).html("Grand Total no. of Endorsed:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(generate_beneficiaries) );
                    ...
                    approve_by_budget = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 3 ).footer() ).html("Grand Total no. of Reviewed:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(approve_by_budget) );
                    ...
                    approve_by_disburse = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 4 ).footer() ).html("Grand Total no. of Approved:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(approve_by_disburse) );
                }, 
            });
            ...
            var table = $('#co-program-focal-report_approval').DataTable({
                ...
                "footerCallback": function ( row, data, start, end, display ) {
                    ...
                    total_upload_kyc = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 3 ).footer() ).html("Grand Total no. of Uploaded KYC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(total_upload_kyc) );
                    ...
                    generate_beneficiaries = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 4 ).footer() ).html("Grand Total no. of Endorsed:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(generate_beneficiaries) );
                    ...
                    approve_by_budget = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 5 ).footer() ).html("Grand Total no. of Reviewed:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(approve_by_budget) );
                    ...
                    approve_by_disburse = api
                        ...
                        .reduce( function (a, b) {
                                    return (a)*1 + (b)*1;}, 0 );
                        $( api.column( 6 ).footer() ).html("Grand Total no. of Approved:&nbsp;&nbsp;&nbsp;&nbsp;"+$.fn.dataTable.render.number(',').display(approve_by_disburse) );
                }, 
            });
            ...
            */
            multi_select_region_table_05();

            /**
             * Mutli-Select Filter
             * Location: ReportModule::components.js.dropdown.by_reg_prov_muni_and_brgy_summary_dynamic_dropdown
            */
            multi_select_province_table_05();
